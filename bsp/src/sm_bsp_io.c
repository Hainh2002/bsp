...
static sm_hal_io_t* in_key;
static sm_hal_io_t* in_horn;
static sm_hal_io_t* in_phase_light;
static sm_hal_io_t* in_head_light;
static sm_hal_io_t* in_turn_left_light;
static sm_hal_io_t* in_turn_right_light;
static sm_hal_io_t* in_eco_sport;
static sm_hal_io_t* in_parking;
static sm_hal_io_t* out_phase_light;
static sm_hal_io_t* out_turn_left_light;
static sm_hal_io_t* out_turn_right_light;
static sm_hal_io_t* out_horn;
static sm_hal_io_t* out_charger;
static sm_hal_io_t* out_mc_power;
static sm_hal_io_t* out_can_mode;
static sm_hal_io_t* out_sw_12v;
static sm_hal_io_t* out_abp_charger;
static sm_hal_io_t* out_node_id_1;
static sm_hal_io_t* out_node_id_2;
static sm_hal_io_t* out_node_id_3;

int32_t sm_bsp_io_get_value_key(){
    in_key = sm_hal_io_init (&io_func, (void*) &g_ioport, IN_KEY);
